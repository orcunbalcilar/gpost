...
/**
 * Java wrapper for the Groovy PostTestStep class.
 */
public class PostTestStepWrapper {
    
    private final Object groovyStep;
    
    public PostTestStepWrapper(Object groovyStep) {
     ...
     */
    public PostTestStepWrapper url(String url) {
        try {
     ...
     * @return This wrapper for method chaining
     */
    public PostTestStepWrapper name(String name) {
        try {
     ...
     * @return This wrapper for method chaining
     */
    public PostTestStepWrapper timeout(int timeout) {
        try {
     ...
     * @return This wrapper for method chaining
     */
    public PostTestStepWrapper request(RequestWithBodyConfig config) {
        try {
     ...
     * @return This wrapper for method chaining
     */
    public PostTestStepWrapper assertions(GetTestStepWrapper.AssertionsConfig config) {
        try {
            // Create a Groovy closure that wraps the Java configuration
            Closure<?> groovyClosure = new Closure<Object>(this) {
                @Override
    ...
    /**
     * Interface for configuring a request with body.
     */
    @FunctionalInterface
    public interface RequestWithBodyConfig {
        void configure(RequestWithBodyWrapper request);
    }
}